...
\begin{lstlisting}[caption={Factory example taken from \href{https://www.programcreek.com/java-api-examples/?code=STAMP-project/dspot/dspot-master/dspot/src/main/java/fr/inria/diversify/utils/sosiefier/TestLogProcessor.java}{Spoon Projects}}]% Start your code-block
